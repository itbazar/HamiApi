...
public class InspectorController : ApiController
{
    ...
    [HttpGet("List")]
    public async Task<ActionResult<List<Complaint>>> List([FromQuery] PagingInfo pagingInfo)
    {
    ...
    [HttpGet("Get")]
    public async Task<ActionResult<Complaint>> Get([FromQuery] ComplaintInspectorGetDto complaintDto)
    {
